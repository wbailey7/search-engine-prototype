...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 12 20:35:32 2019
Author: Wes Bailey
Description:
"""
...
res = es.search(index="english", body={"from":0, "size":2, "query":{"match_phrase":{"sentence":"bright SUNNY"}}})
res

res = es.search(index="english", body={"from":0, "size":2, "query":{"term":{"sentence":"bright SUNNY"}}})
res
